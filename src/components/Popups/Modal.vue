...
import AddTestimonial from "../../Layouts/Reviews/ReviewAdd.vue";
import {useFetch} from "../../assets/js/controllers/requestsControl.js";
import {store} from "../../assets/js/services/categoriesService.js";
import product_Add from "../../Blocks/Controllers/ProductAdd.vue";
import {signOut} from "../../assets/js/services/userService.js";

export default {
  name: "Modal.vue",
  components: {AddTestimonial, VScrollLock, product_Add},
