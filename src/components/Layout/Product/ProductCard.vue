<template>
  <div class="service-card" @click="this.$emit('productInfo')">
    ...
    <div class="admin-menu" v-if="$props.isEditable">
      <div class="item" @click="this.$emit('editProduct')"  @click.stop>
      ...
      <div class="item" @click="this.$emit('deleteProduct')"  @click.stop>
