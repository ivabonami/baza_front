    ...
    <div v-else-if="this.userHere === true" class="loggined">
      ...
      v-on:click="signOut()">
        <g clip-path="url(#clip0_374_5108)">
          ...
          <path d="M14.5362 17.1399V13.8091H6.73376V9.19171H14.5262V5.86572C16.3555 7.75589 18.1891 9.65091 19.9995 11.5227C18.2273 13.3445 16.3859 15.2379 14.5362 17.1394V17.1399Z" fill="#6C7AFF"/>
        </g>
        <defs>
...
export default {
  ...
  mounted() {
    if ( localStorage.getItem('token') ) {
      this.userHere = true
      this.username = localStorage.getItem('signedUsername')
      console.log( 'asdasdas' + localStorage.getItem('token'))
