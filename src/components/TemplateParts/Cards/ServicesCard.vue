<template>
  <div class="service-card can-be-hovered" ref="card"
       ...
       v-on:click="() => {
             if ($props.clickable === true) {
               ...
               this.highlight.id = $props.id
                ...
                modalSetting.image = $props.image
                modalSetting.headline = $props.name
                modalSetting.description = $props.description
    ...
    <button class="btn btn-delete"
            ...
            v-on:click="() => {
              ...
              this.actionModal.headline = 'Удалить услугу?',
              this.actionModal.description = 'Вы уверены что хотите удалить услугу ' + $props.name + '?'
    ...
    <button class="btn btn-edit"
            ...
            v-on:click="() => {
              ...
              editProduct.product.name = $props.name
              editProduct.product.image = $props.image
              editProduct.product.description = $props.description
              editProduct.product.id = $props.id
  ...
  <action-modal v-if="actionModal.show === true"
...
import {highlight, editProduct} from "../../../assets/js/productController.js";
