      ...
      <div class="project-reviews_items_item_data">
        <div class="project-reviews_items_item_heading">
          ...
          <div class="rating">
            ...
            <svg v-for="rating of review.rating" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    ...
    normalizeData(date) {
      ...
      const data = `${projectDate.getHours()}:${projectDate.getMinutes()} ${projectDate.getDay()}.${projectDate.getMonth()}.${projectDate.getFullYear()}`
      return data
    },
