<template>
          ...
          <div class="ps-lg-1">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <a href="/"
                 ...
                 v-on:click="this.leaveAdmin()">Leave admin panel</a>
            </div>
          </div>
          <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="add-items d-flex">
                    ...
                    <button class="add btn btn-gradient-primary font-weight-bold todo-list-add-btn" id="add-task">Add
                    </button>
                  </div>
  ...
  <!--  &lt;!&ndash; endinject &ndash;&gt;-->
  <!--  &lt;!&ndash; Custom js for this page &ndash;&gt;-->
  <!--  <script src="assets/js/dashboard.js"></script>-->
  <!--  <script src="assets/js/todolist.js"></script>-->
  <!--  &lt;!&ndash; End custom js for this page &ndash;&gt;-->

</template>

<script>
export default {
  name: "AdminPageView.vue",
  components: 'AdminPageView',
