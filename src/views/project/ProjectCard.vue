    ...
    >
      ...
      <div class="project-body" v-on:click="$router.push('/project/' + $props.project.id)">
        <div class="project-top">
          ...
          <div class="rating hoverable" v-on:click="$router.push('/project/' + $props.project.id)">
        ...
        <div class="project-description hoverable" v-on:click="$router.push('/project/' + $props.project.id)">
        ...
        <div class="project-bottom">
          <div class="stats">
            <div class="testimonials hoverable">
              ...
              <span> Отзывов: {{ $props.project.reviewsCount || 0 }}</span>
            </div>
            <div class="views hoverable">
        ...
        <div class="advanced-fields" v-if="$props.project.type === 'exchanger'">
          ...
          <div class="stat">
            ...
            Курс: {{ $props.project.exchangeRate }}$
          </div>
          ...
          <div class="stat">
            ...
            Мин. обмен: {{ $props.project.minValueToExchange }}$
          </div>
        </div>
      </div>
