    ...
    <div class="project"
      ...
      <div class="project-body" v-on:click="$router.push('/project/' + projectId)">
        ...
        <div class="project-bottom">
          <div class="stats">
            <div class="testimonials hoverable" title="Отзывов" v-on:click.stop v-on:click="$router.push('/project/' + projectId)">
        ...
        <div class="advanced-fields" v-if="$props.isExchanger === 'exchanger'">
          <div class="stat">
          ...
          <div class="stat">
            ...
            Мин. обмен: {{ $props.minValueToExchange }}$
          </div>
        </div>
      </div>
