<template>
  <div class="filter" data-dropdown="true">
    <div
      ...
      <svg data-dropdown xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      <span data-dropdown class="sort">
        {{ normalizeSortName($props.sort.name) }}
      </span>
    </div>
